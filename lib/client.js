		...
		function VersionTab({ t }) {
			...
			return h("section", { className: "dv_section" },
				h("div", { className: "dv_head" },
					h("h3", null, t("title")),
					h("button", { className: "dv_btn dv_btnSmall", onClick: onRelaunch }, t("relaunch"))),
				...
				h(ReleasesTable, { t, releases, current, busy, onInstall, confirmTarget }),
				h(HistorySection, { t, history, busy, onRestore, confirmTarget }),
